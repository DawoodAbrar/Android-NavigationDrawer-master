    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_sign_in:
                getSupportFragmentManager().beginTransaction().replace(R.id.framelayout_id, new SignInFragment())
                        .commit();
                closeDrawer();
                break;
            case R.id.nav_sign_up:
                getSupportFragmentManager().beginTransaction().replace(R.id.framelayout_id, new SignUpFragment())
                        .commit();
                closeDrawer();
                break;
            case R.id.nav_home:
